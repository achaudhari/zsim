...
g_task_db = ({
    ...
    'facesim-sm':'cd $PARSEC_APPS_PATH/facesim/inst/amd64-linux.gcc/bin-sm; ./facesim -threads 4',
    'facesim-md':'cd $PARSEC_APPS_PATH/facesim/inst/amd64-linux.gcc/bin-md; ./facesim -threads 4',
    'facesim-lg':'cd $PARSEC_APPS_PATH/facesim/inst/amd64-linux.gcc/bin-lg; ./facesim -threads 4',
