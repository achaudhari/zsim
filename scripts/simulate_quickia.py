...
# Task ID to command mapping code
g_props_db = ({
    'blackscholes-sm':  proc_props_t(energy=89,phase=9411,l1misses=174260,l2misses=5715,sharing=1000),
    'blackscholes-md':  proc_props_t(energy=89,phase=9411,l1misses=174260,l2misses=5715,sharing=1000),
    'blackscholes-lg':  proc_props_t(energy=89,phase=9411,l1misses=174260,l2misses=5715,sharing=1000),
    'fluidanimate-sm':  proc_props_t(energy=108,phase=12784,l1misses=789020,l2misses=661065,sharing=8),
    'fluidanimate-md':  proc_props_t(energy=108,phase=12784,l1misses=789020,l2misses=661065,sharing=8),
    'fluidanimate-lg':  proc_props_t(energy=108,phase=12784,l1misses=789020,l2misses=661065,sharing=8),
    'facesim-sm':       proc_props_t(energy=75,phase=10261,l1misses=78387,l2misses=78387,sharing=79),
    'facesim-md':       proc_props_t(energy=75,phase=10261,l1misses=78387,l2misses=78387,sharing=79),
    'facesim-lg':       proc_props_t(energy=75,phase=10261,l1misses=78387,l2misses=78387,sharing=79),
    'swaptions-sm':     proc_props_t(energy=21,phase=2152,l1misses=196517,l2misses=19416,sharing=711),
    'swaptions-md':     proc_props_t(energy=21,phase=2152,l1misses=196517,l2misses=19416,sharing=711),
    'swaptions-lg':     proc_props_t(energy=21,phase=2152,l1misses=196517,l2misses=19416,sharing=711),
    'x264-sm':          proc_props_t(energy=79,phase=8551,l1misses=2515517,l2misses=151939,sharing=79),
    'x264-md':          proc_props_t(energy=79,phase=8551,l1misses=2515517,l2misses=151939,sharing=79),
    'x264-lg':          proc_props_t(energy=79,phase=8551,l1misses=2515517,l2misses=151939,sharing=79),
    'raytrace':         proc_props_t(energy=75,phase=10445,l1misses=18244,l2misses=10847,sharing=389),
    'vips-sm':          proc_props_t(energy=81,phase=9756,l1misses=1300887,l2misses=193887,sharing=61),
    'vips-md':          proc_props_t(energy=81,phase=9756,l1misses=1300887,l2misses=193887,sharing=61),
    'vips-lg':          proc_props_t(energy=81,phase=9756,l1misses=1300887,l2misses=193887,sharing=61),
